...
export const fetchRecords: (type: string, params?: object) => Promise<any> | Action;
export const fetchRecord: (type: string , id: any, params?: object) => Promise<any> | Action;
export const saveRecord: (record: ApiRecord, params?: object) => Promise<any> | Action;
export const deleteRecord: (record: ApiRecord) => Promise<any> | Action;
