...
export const fetchRecords: (type: string, params?: object, options?: { replace?: boolean }) => Promise<any>;
export const fetchRecord: (type: string , id: any, params?: object, options?: { replace?: boolean }) => Promise<any>;
export const saveRecord: (record: ApiRecord, options?: { ignoreFail?: boolean; params?: object; replace?: boolean }) => Promise<any>;
